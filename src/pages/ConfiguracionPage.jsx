            ...
            <div className="flex-1 p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {DataModulosConfiguracion.map((item, index) => (
                        <Link to={item.link} key={index} className="card-content bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                            <div className="p-4">
                                <div className="card-image mb-4">
                                    <img src={item.image || ''} alt="icono de opción" className="w-full h-32 object-cover" />
                                </div>
